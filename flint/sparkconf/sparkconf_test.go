...
func TestSparkConf_Set(t *testing.T) {
	...
	if returnedConf != conf {
		t.Errorf("Set() должен возвращать тот же экземпляр SyncSparkConf")
	}
...
func TestSparkConf_Remove(t *testing.T) {
	...
	// Проверка цепочки вызовов
	if returnedConf != conf {
		t.Errorf("Remove() должен возвращать тот же экземпляр SyncSparkConf")
	}
...
func TestSparkConf_SetIfMissing(t *testing.T) {
	...
	// Проверка цепочки вызовов
	if returnedConf != conf {
		t.Errorf("SetIfMissing() должен возвращать тот же экземпляр SyncSparkConf")
	}
...
func TestSparkConf_Merge(t *testing.T) {
	...
	if returnedConf != conf1 {
		t.Errorf("Merge() должен возвращать тот же экземпляр SyncSparkConf")
	}
